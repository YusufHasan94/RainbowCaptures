...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <section class="creativeWork">
        <div class="contitleArea">
          <h1 class="contentTitle">Our Creative Works</h1>
        </div>
        <div class="CWContainer container">
          <div class="CWAlbum Album1">
            <div class="card" style="width: 18rem">
              <img
                src="../picture/1667753041521.jpg"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
          ...
          <div class="CWAlbum Album2">
            <div class="card" style="width: 18rem">
              <img
                src="../picture/1667753041577.jpg"
                class="card-img-top"
                alt="..."
                width=""
              />
          ...
          <div class="CWAlbum Album3">
            <div class="card" style="width: 18rem">
              <img src="../picture/pic017.jpg" class="card-img-top" alt="..." />
              <div class="card-body">
          ...
          <div class="CWAlbum Album4">
            <div class="card" style="width: 18rem">
              <img
                src="../picture/newDSC_1065.jpg"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
          ...
          <div class="CWAlbum Album5">
            <div class="card" style="width: 18rem">
              <img
                src="../picture/newpic018.jpg"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
                <h5 class="card-title">Album 5</h5>
                <p class="card-text">
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
                </p>
          ...
          <div class="CWAlbum Album6">
            <div class="card" style="width: 18rem">
              <img
                src="../picture/DSC_4775.jpg"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
                <h5 class="card-title">Album 6</h5>
                <p class="card-text">
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
                </p>
